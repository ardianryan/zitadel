...
export function ZitadelLogo({ height = 14, width = 52, className = "" }: Props) {
  return (
    <span className={`inline-flex items-center ${className}`} style={{ height: `${height}px`, width: `${width}px` }}>
      {/* Light Mode SVG (Dark text) */}
      <svg className="block h-full w-full dark:hidden" viewBox="0 0 295 81" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      {/* Dark Mode SVG (White text) */}
      <svg className="hidden h-full w-full dark:block" viewBox="0 0 295 81" fill="none" xmlns="http://www.w3.org/2000/svg">
        <g transform="matrix(1,0,0,1,0,-107)">
          <g id="zitadel-logo-light" transform="matrix(1,0,0,1,-20.9181,18.2562)">
            <g transform="matrix(2.73916,0,0,1.55095,-35271.3,23.6234)">
              <g transform="matrix(0.160219,-0.0758207,0.0429306,0.282967,12622.8,-105.843)">
                <path
                  d="M1493.5,1056.38L1493.5,1037L1496.5,1037L1496.5,1061.62L1426.02,1020.38L1496.5,979.392L1496.5,1004L1493.5,1004L1493.5,984.608L1431.98,1020.39L1493.5,1056.38Z"
              ...
              <g>
                <g transform="matrix(-0.0429306,-0.282967,0.160219,-0.0758207,12884.5,137.392)">
                  <path
                    d="M212.517,110L200.392,110L190,92L179.608,110L167.483,110L190,71L212.517,110Z"
                    fill="url(#_zl_Linear1_d)"
                  />
                </g>
                <g transform="matrix(0.160219,0.0758207,-0.0429306,0.282967,12878.9,10.8747)">
                  <path
                    d="M212.517,110L200.392,110L190,92L179.608,110L167.483,110L190,71L212.517,110Z"
                    fill="url(#_zl_Linear2_d)"
                  />
                </g>
                <g transform="matrix(-0.117289,0.207146,-0.117289,-0.207146,12943.8,65.7)">
                  <path
                    d="M212.517,110L200.392,110L190,92L179.608,110L167.483,110L190,71L212.517,110Z"
                    fill="url(#_zl_Linear3_d)"
                  />
                </g>
                <g transform="matrix(-0.160219,-0.0758207,0.0429306,-0.282967,12917.4,132.195)">
                  <path d="M139.622,117L149,142L130.244,142L139.622,117Z" fill="url(#_zl_Linear4_d)" />
                </g>
                <g transform="matrix(-0.117289,0.207146,0.117289,0.207146,12897.8,5.87512)">
                  <path d="M139.622,117L149,142L130.244,142L139.622,117Z" fill="url(#_zl_Linear5_d)" />
                </g>
                <g transform="matrix(-0.0429306,-0.282967,-0.160219,0.0758207,12936.8,97.6441)">
                  <path d="M139.622,117L149,142L130.244,142L139.622,117Z" fill="url(#_zl_Linear6_d)" />
                </g>
              </g>
              <g transform="matrix(0.160219,-0.0758207,0.0429306,0.282967,12622.6,-105.767)">
                <circle cx="1496" cy="1004" r="7" fill="#FFFFFF" />
              </g>
              <g transform="matrix(0.160219,-0.0758207,0.0429306,0.282967,12624.1,-96.4295)">
                <circle cx="1496" cy="1004" r="7" fill="#FFFFFF" />
              </g>
